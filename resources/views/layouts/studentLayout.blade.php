...
<html lang="en">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="{{ route('student.dashboard') }}">Student Portal</a>
            <!-- Sidebar Toggle-->
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Student Information System 2025</div>
                            <div>
        ...
        <script src="{{ asset('js/datatables-simple-demo.js') }}"></script>    </body>
</html>